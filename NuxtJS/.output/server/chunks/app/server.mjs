...
const _routes = [
  {
    ...
    file: "/mnt/c/code/jluterek/jsframework-api-examples/NuxtJS/pages/index.vue",
    children: [],
    meta: __nuxt_page_meta,
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./_nuxt/index.8e67ef14.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.d3f2f369.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
